...
.addr-form{ max-width: 480px; padding:16px; background:#ffffff; border:1px solid var(--el-border-color-light); border-radius:12px; box-shadow: 0 6px 16px rgba(24,52,110,0.06); }
.sum{ text-align:right; margin:12px 0; font-weight:600; color: var(--brand-800); }
</style>
