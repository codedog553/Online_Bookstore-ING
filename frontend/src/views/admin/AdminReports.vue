<template>
  <div>
    ...
    <el-row :gutter="16" class="mb16">
      <el-col :span="6">
        <el-statistic class="stats-card" :title="t('admin.totalSales')" :value="summary?.total_sales ?? 0" prefix="￥" />
      </el-col>
      <el-col :span="6">
        <el-statistic class="stats-card" :title="t('admin.orderCount')" :value="summary?.order_count ?? 0" />
      </el-col>
    </el-row>
...
.stats-card {
  ...
  border-radius: 12px;
  box-shadow: 0 6px 16px rgba(24, 52, 110, 0.06);
}
